...
class PlayerTest {
        ...
        public PlayerTest(String name, int id, List<TalentTree> talentTreeList, List<Inventory> inventoryList, int experience, int currency, String className, int hp, int damage, int resource, int strength, int agility, int intellect, int level, int defence, int initiative, boolean isDead, boolean hasPlayed) {
            this.name = name;
            this.id = id;
            this.talentTreeList = talentTreeList;
            this.inventoryList = inventoryList;
